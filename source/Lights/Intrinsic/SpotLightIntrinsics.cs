...
{
    public class SpotLightIntrinsics : DeferredShaderIntrinsicLights<SpotLight>
    {
        ...
        static Vector4f DirectionFalloff(SpotLight l) => new Vector4f(l.direction, l.falloff);
        ...
        protected override SysCol.IEnumerable<ShadeInput> CreateShadeInputs()
        {
            ...
            yield return new ShadeInstanceInput<Vector4f>("vec4", "DIRECTION_FALLOFF", maxLights, DirectionFalloff, new Vector4f(1, 0, 0, 0));
